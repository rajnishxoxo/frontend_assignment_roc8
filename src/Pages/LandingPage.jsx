...
const LandingPage = () => {
  return (
    <>
      ...
      >
        <div
          className=" absolute flex justify-between w-[1217.484px] h-[67.688px] items-center mt-10"
          style={{
        ...
        >
          ...
          <div className="w-[300px] flex justify-evenly">
            ...
            <button className="w-52 text-white font-euclid-circular-b text-[17.813px] font-semibold leading-19.95 rounded-[8.906px] border-[2.672px] border-white">
              Create Account
            </button>
          </div>
        </div>
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
        <h1 className="text-white text-shadow font-euclid-circular-b text-[60px] font-bold leading-[80px]">
